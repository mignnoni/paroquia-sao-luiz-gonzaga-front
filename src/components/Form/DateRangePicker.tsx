...
export function DateRangePicker({ setMonth, setYear, disabled, initialMonth, initialYear }: DateRangePickerProps) {
    const [initialDate] = useState<InitialDate>(() => {
        let m = initialMonth ?? new Date().getMonth() + 1;
        let y = initialYear ?? new Date().getFullYear();
